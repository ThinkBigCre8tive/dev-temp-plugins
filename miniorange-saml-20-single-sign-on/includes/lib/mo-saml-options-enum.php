...
class mo_saml_options_addons extends MoSAMLBasicEnum{
    ...
    public static $ADDON_DESC = array(

        'scim'                          =>  'This plugin allows real-time user sync from your Identity Provider such as Azure, Okta, Onelogin into your WordPress site.',
        'page_restriction'              =>  'Restrict access to WordPress pages/posts based on user roles and their login status, thereby protecting these pages/posts from unauthorized access.',
        'file_prevention'               =>  'Restrict any kind of media files such as images, audio, videos, documents, etc. Also restrict media files of any extension(configurable) such as png, pdf, jpeg, jpg, bmp, gif, etc.',
        'ssologin'                      =>  'SSO Login Audit captures all the SSO users and will generate the reports. It make easy to find and keep track of your users in the audit reports with the help of advanced search filters.',
        'buddypress'                    =>  'Integrate user information sent by the SAML Identity Provider in SAML Assertion with the BuddyPress profile fields.',
        'learndash'                     =>  'LearnDash is a popular WordPress LMS plugin. You can map your users to different LearnDash groups as per their group information sent by the SAML Identity Provider.',
        'attribute_based_redirection'   =>  'ABR add-on helps you to redirect your users to different pages after they log into your site, based on the attributes sent by your Identity Provider.',
        'ssosession'                    =>  'SSO session management add-on manages the login session time of your users based on their WordPress roles. Role-based session management is also available.',
        'fsso'                          =>  'This add-on provides secure access to the site using various federations such as InCommon, HAKA, HKAF, etc. Users can log into the WordPress site using their university credentials.',
        'paid_mem_pro'                  =>  'Map your users to different PMPro membership levels as per the group information sent by your Identity Provider.',
        'memberpress'                   =>  'Map users to different membership levels created by the MemberPress plugin using the group information sent by your Identity Provider.',
        'wp_members'                    =>  'Integrate WP-members fields using the attributes sent by your SAML Identity Provider in the SAML Assertion.',
        'woocommerce'                   =>  'Map WooCommerce checkout page attribute fields using the attributes sent by your SAML IDP. This also allows you to map the users in different WooCommerce roles based on their IDP groups.',
        'guest_login'                   =>  'Allows users to SSO into your site without creating a user account for them. This is useful when you dont want to manage the user accounts at the WordPress site'
    );
    ...
    public static $ADDON_URL = array(
        ...
        'learndash'                     =>  'https://plugins.miniorange.com/wordpress-learndash-integrator#:~:text=miniOrange%20LearnDash%20Integrator%20allows%20you,following%20attributes%20while%20performing%20SSO',
    ...
    public static $ADDON_TITLE = array(
        ...
        'scim'                          =>  'Real Time User Provisioning with SCIM',
        ...
        'paid_mem_pro'                  =>  'Paid membership pro',
        'memberpress'                   =>  'Member Press',
        'wp_members'                    =>  'WP member',
