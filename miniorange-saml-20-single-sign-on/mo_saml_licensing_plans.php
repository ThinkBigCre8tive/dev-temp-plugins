...
<div style="text-align: center; font-size: 14px; background: forestgreen; color: white; padding-top: 4px; padding-bottom: 4px; border-radius: 16px;"><?php echo get_option('mo_saml_license_message'); ?></div>
    ...
    <div class="tab-pane active text-center" id="cloud">
        ...
        <div class="cd-pricing-container cd-has-margins"><br>
            ...
            <div style="background: #F2F5FB;border-radius:5px;font-size: large;margin-top:10px;padding:10px;border-style: solid;border-color: #2f6062">
                    ...
                    License is linked to the domain of the Wordpress instance, so if you have dev-staging-prod type of environment then you will require 3 licenses of the plugin (with discounts applicable on pre-production environments). Contact us at <a style="color:blue
    " href="mailto:info@xecurify.com">info@xecurify.com</a> for bulk discounts.
        ...
        <div style="text-align:left; font-size:12px;  padding-right:30px;">
            ...
            <li class="bottom-heading"> Multiple IdPs Supported -</li>
            <p style="padding-left:14px"><b>*</b> There is an additional cost for the IdPs if the number of IdP is more than 1.</p>
            <br/>
            <p>
