...
if($tab == 'default' && get_option('plugin_wise_tour_initiated')==1)
{
    ...
    $pointers['default-miniorange-select-your-idp'] = array(
        'title'     => sprintf( '<h3>%s</h3>', esc_html__( 'Select ADFS as IDP (Step 1 of 9)' ) ),
    ...
    $pointers['default-miniorange-sp-metadata-url'] = array(
        'title'     => sprintf( '<h3>%s</h3>', esc_html__( 'Service Provider Metadata URL (Step 2 of 9)' ) ),
    ...
    $pointers['default-miniorange-upload-metadata'] = array(
        'title'     => sprintf( '<h3>%s</h3>', esc_html__( 'Upload your metadata (Step 3 of 9)' ) ),
    ...
    $pointers['default-miniorange-test-configuration'] = array(
        'title'     => sprintf( '<h3>%s</h3>', esc_html__( 'Check your configurations (Step 4 of 9)' ) ),
    ...
    $pointers['default-miniorange-attribute-mapping'] = array(
        'title'     => sprintf( '<h3>%s</h3>', esc_html__( 'Configure Attribute Mapping (Step 5 of 9)' ) ),
    ...
    $pointers['default-miniorange-role-mapping'] = array(
        'title'     => sprintf( '<h3>%s</h3>', esc_html__( 'Configure Role Mapping (Step 6 of 9)' ) ),
    ...
    $pointers['default-minorange-use-widget'] = array(
        'title'     => sprintf( '<h3>%s</h3>', esc_html__( 'Available with this version (Step 7 of 9)' ) ),
    ...
    $pointers['default-miniorange-addons'] = array(
        'title'     => sprintf( '<h3>%s</h3>', esc_html__( 'Add-Ons (Step 8 of 9)' ) ),
        'content'   => sprintf( '<p>%s</p>', esc_html__( 'Checkout all our add-ons to extend the SSO functionality.' ) ),
